      ...
      <footer>
        <nav className="footer">
          <div className="github">
            <a
              href="https://github.com/CatherineJOnia"
          ...
          <div>
            <a
              href="https://www.linkedin.com/in/catherineonia/"
              rel="noopener noreferrer"
              target="_blank"
              className="linkedin"
            >
          ...
          <div>
            <a href="mailto:catherinejoniay@gmail.com" className="email">
              <svg viewBox="0 0 16 16">
        ...
        <div className="col-md-12">
          ...
          <div>
            <a className="static-email" href="mailto:catherinejonia@gmailcom">
              catherinejonia@gmail.com
            </a>
          </div>
